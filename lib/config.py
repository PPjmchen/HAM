...
# path
CONF.PATH = EasyDict()
CONF.PATH.BASE = "/root/3DVG/osvg-3D/" # TODO: change this
...
# data
CONF.SCANNET_DIR =  "/root/3DVG/osvg-3D/data/scannet/scans" # TODO change this
CONF.SCANNET_FRAMES_ROOT = "/root/3DVG/osvg-3D/data/frames_square/" # TODO change this
CONF.PROJECTION = "/root/3DVG/osvg-3D/data/multiview_projection_scanrefer" # TODO change this
CONF.ENET_FEATURES_ROOT = "/root/3DVG/osvg-3D/data/enet_features" # TODO change this
